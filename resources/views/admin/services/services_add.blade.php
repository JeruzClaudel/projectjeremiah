...
<div class="top-bar">
    ...
    <h2 class="navigation-title">Add Service</h2>
</div>
...
<div class="pane">
    <div class="right-side" style="max-width:620px;">
        <form action="{{ route('admin.services.store') }}" method="POST" class="form-example">
                ...
                <div class="information">
                    ...
                    <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px;">
                        <input type="checkbox" id="has_link" name="has_link" value="1"
                               {{ old('has_link') || old('consultations_id') ? 'checked' : '' }}
                    ...
                    <div id="link-wrap" style="{{ old('has_link') || old('consultations_id') ? '' : 'display:none;' }}">
                        <input type="url" name="consultations_id" id="consultations_id"
                               class="content"
                               value="{{ old('consultations_id') }}"
            ...
            <input class="add-button" type="submit" value="Save Service">
        </form>
    </div>
</div>
