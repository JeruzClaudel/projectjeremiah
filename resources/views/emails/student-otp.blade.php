...
<head>
    ...
    <title>Account Reactivation — Project Jeremiah 33:3</title>
    <style>
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p style="color:#374151; font-size:.9rem; line-height:1.7; margin-bottom:20px;">
            We received a request to reactivate your account. Enter the code below on the
            reactivation page to restore access to e-Hayag.
        </p>
        ...
        <div class="info-box">
            <strong>Important:</strong> If you did not request this reactivation,
            please ignore this email &mdash; your account will remain deactivated.
        </div>

        <p style="color:#6b7280; font-size:.82rem; line-height:1.65;">
            Maximum 3 attempts. You must wait 60 seconds before requesting a new code.
        </p>
    </div>
    <div class="footer">
